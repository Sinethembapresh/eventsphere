...
export default function HomePage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-pink-100 via-white to-blue-100">
      {/* Hero Section */}
      <section className="relative w-screen h-[100vh] flex items-center justify-center overflow-hidden pt-20">
      ...
      <section className="py-20 px-4 sm:px-8 lg:px-16">
        <div className="max-w-4xl mx-auto text-center grid md:grid-cols-2 gap-8">
          ...
          <Card className="bg-gradient-to-r from-blue-600 to-indigo-600 text-white">
            <CardContent className="p-12">
              ...
              <p className="text-xl mb-8 text-blue-100">
                Join thousands of students already using EventSphere to enhance
