      ...
      <section className="relative w-screen h-[100vh] flex items-center justify-center overflow-hidden p-0 m-0">
        ...
        <div className="max-w-5xl mx-auto text-center relative z-10">
          ...
          <motion.p
            ...
            style={{ willChange: "opacity, transform" }}
          >
            {"Your comprehensive college event management system. Discover, participate, and organize amazing events that shape your college experience.".split(" ").map((word, index) => (
              <motion.span
                key={index}
                initial={{ opacity: 0, y: 20 }}
                animate={{ opacity: 1, y: 0 }}
